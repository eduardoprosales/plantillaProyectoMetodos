...
import proyectoMetodos.backend.Crout;

public class VentanaCrout extends JDialog {
	...
	public static void main(String[] args) {
		try {
			VentanaCrout dialog = new VentanaCrout();
	...
	public VentanaCrout() {
		...
		{
			JLabel lblNewLabel = new JLabel("Factorización Crout");
